...
public class NoticiaPreferenciasAdapter extends RecyclerView.Adapter<NoticiaPreferenciasAdapter.ViewHolder> {
    ...
    public NoticiaPreferenciasAdapter(List<NoticiaFromApi> listaNoticias, NoticiaListener noticiaListener){
